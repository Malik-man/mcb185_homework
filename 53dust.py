...
parser.add_argument('--entropy', type=float, default=1.4 ,help='entropy threshold [%(defealt)f.3f]')
...
for defline, seq in mcb185.read_fasta(arg.fasta):
	...
	for i in range(0, len(seq), arg.wrap):
		...
		#mask[5] = 'n' # we can edit any position and make an n
		#print(win) # cant use a string need to make a list 
